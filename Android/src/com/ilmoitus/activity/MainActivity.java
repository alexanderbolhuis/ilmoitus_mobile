...
public class MainActivity extends Activity {
	...
	private class GetDeclerationsTask extends AsyncTask<Void, Void, String>{
		...
		protected String doInBackground(Void... params) {
		    ...
		    HttpGet httpGet = new HttpGet("http://2.sns-ilmoitus.appspot.com/declarations/employee");
		...
		protected void onPostExecute(String result) {
			try {
				...
				titleView.setText("Ingelogd als " + LoggedInPerson.firstName + " " + LoggedInPerson.lastName + " (" + LoggedInPerson.employeeNumber + ")");
				DeclarationOverviewAdapter adapter = new DeclarationOverviewAdapter(activity, declarations);
